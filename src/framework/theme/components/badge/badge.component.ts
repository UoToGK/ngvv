...
export type DyBadgePhysicalPosition = 'top left' | 'top right' | 'bottom left' | 'bottom right' | 'center right' | 'center left';
export type DyBadgeLogicalPosition = 'top start' | 'top end' | 'bottom start' | 'bottom end' | 'center start'| 'center end';
export type DyBadgePosition = DyBadgePhysicalPosition | DyBadgeLogicalPosition;

export interface DyBadge {
  text?: string;
  position?: DyBadgePosition;
 ...
 * ### Installation
 *
 * Import `DyBadgeModule` to your feature module.
 * ```ts
 * @NgModule({
 *   imports: [
 *     // ...
 ...
 *
 * ```html
 * <dy-badge text="badgeText"></dy-badge>
 * ```
 *
 * For example, badge can be placed into dy-card header:
 * @stacked-example(Showcase, badge/badge-showcase.component)
 *
 * Badge located on the bottom right with warning status:
 *
 * ```html
 * <dy-badge text="badgeText" status="warning" position="bottom right">
 * </dy-badge>
 * ```
 *
 * @styles
...
export class DyBadgeComponent implements DyBadge {
   ...
   */
  @Input()
  get position(): DyBadgePosition {
    return this._position;
  }
  set position(value: DyBadgePosition) {
    this._position = value || this._defaultPosition;
  }
  protected _defaultPosition: DyBadgePosition = 'top right';
  protected _position: DyBadgePosition = this._defaultPosition;
