 ...
 * ### Installation
 *
 * Import `DyCheckboxComponent` to your feature module.
 * ```ts
 * @NgModule({
 *   imports: [
 *     // ...
...
@Component({
  ...
  template: `
    <label class="label">
      ...
      <span [class.indeterminate]="indeterminate" [class.checked]="checked" class="custom-checkbox">
        <dy-icon *ngIf="indeterminate" icon="minus-bold-outline" pack="nebular-essentials"></dy-icon>
        <dy-icon *ngIf="checked && !indeterminate" icon="checkmark-bold-outline" pack="nebular-essentials"></dy-icon>
      </span>
      <span class="text">
  ...
  providers: [{
    ...
    useExisting: forwardRef(() => DyCheckboxComponent),
    multi: true,
  }],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DyCheckboxComponent implements AfterViewInit, ControlValueAccessor {
  ...
  static ngAcceptInputType_checked: DyBooleanInput;
  ...
  static ngAcceptInputType_indeterminate: DyBooleanInput;
  ...
  constructor(
    ...
    private zone: NgZone,
    private statusService: DyStatusService,
  ) {}
