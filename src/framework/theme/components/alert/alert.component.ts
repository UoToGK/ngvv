 ...
 *
 * ```html
 * <dy-alert status="success">
 *   You have been successfully authenticated!
 * </dy-alert>
 * ```
 * ### Installation
 *
 * Import `DyAlertModule` to your feature module.
 * ```ts
 * @NgModule({
 *   imports: [
 *     // ...
 ...
 * ```html
 * <dy-alert status="success" closable (close)="onClose()">
 *   You have been successfully authenticated!
 * </dy-alert>
 * ```
 *
...
export class DyAlertComponent {
   ...
   * Unset by default.
   */
  @Input() accent: '' | DyComponentStatus = '';
   ...
   * Unset by default.
   */
  @Input() outline: '' | DyComponentStatus = '';
  ...
  static ngAcceptInputType_closable: DyBooleanInput;
