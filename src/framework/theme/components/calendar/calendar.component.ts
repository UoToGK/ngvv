 ...
 * ### Installation
 *
 * Import `DyCalendarModule` to your feature module.
 * ```ts
 * @NgModule({
 *   imports: [
 *     // ...
 ...
 * ### Usage
 *
 * If you want to select ranges you can use `DyCalendarRangeComponent`.
 *
 * ```html
 * <dy-calendar-range [(range)]="range"></dy-calendar-range>
 * <dy-calendar-range [range]="range" (rangeChange)="handleRangeChange($event)"></dy-calendar-range>
 * ```
 *
 * In order to use it, you have to import `DyCalendarRangeModule`.
...
export class DyCalendarComponent<D> {
   ...
   * */
  @Input() dayCellComponent: Type<DyCalendarCell<D, D>>;

  /**
   * Custom month cell component. Have to implement `DyCalendarCell` interface.
   * */
  @Input() monthCellComponent: Type<DyCalendarCell<D, D>>;

  /**
   * Custom year cell component. Have to implement `DyCalendarCell` interface.
   * */
  @Input() yearCellComponent: Type<DyCalendarCell<D, D>>;
