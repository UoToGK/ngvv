...
/**
 * The `DyAutocompleteComponent` overlay component.
 * Provides an `DyOptionList` overlay component.
 * */
@Component({
  selector: 'dy-autocomplete',
  templateUrl: './autocomplete.component.html',
  styleUrls: ['./autocomplete.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DyAutocompleteComponent<T> implements AfterContentInit, OnDestroy {
   ...
   * */
  id: string = `dy-autocomplete-${lastAutocompleteId++}`;
   ...
   */
  _overlayPosition: DyPosition = '' as DyPosition;

  get overlayPosition(): DyPosition {
    return this._overlayPosition;
  }

  set overlayPosition(value: DyPosition) {
    this._overlayPosition = value;
    // Need run change detection after first set from DyAutocompleteDirective
  ...
  * */
  @ContentChildren(DyOptionComponent, { descendants: true }) options: QueryList<DyOptionComponent<T>>;

  /**
   * DyOptionList with options content.
   * */
