...
import { DySelectedTimeModel } from './model';
import { DyPlatform } from '../cdk/platform/platform-service';

@Component({
  selector: 'dy-timepicker-cell',
  template: `
...
export class DyTimePickerCellComponent implements AfterViewInit, OnDestroy {
  ...
  @Input() value: string;
  @Output() select: EventEmitter<DySelectedTimeModel> = new EventEmitter();
