 ...
 *
 * ```ts
 *   <dy-user name="John Doe" title="Engineer"></dy-user>
 * ```
 *
 * ### Installation
 *
 * Import `DyUserModule` to your feature module.
 * ```ts
 * @NgModule({
 *   imports: [
 *     // ...
...
export class DyUserComponent {
   ...
   */
  @Input() shape: DyComponentShape = 'round';
  ...
  static ngAcceptInputType_showName: DyBooleanInput;
  ...
  static ngAcceptInputType_showTitle: DyBooleanInput;
  ...
  static ngAcceptInputType_showInitials: DyBooleanInput;
  ...
  static ngAcceptInputType_onlyPicture: DyBooleanInput;
