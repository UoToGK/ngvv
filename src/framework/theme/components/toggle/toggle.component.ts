 ...
 * ### Installation
 *
 * Import `DyToggleComponent` to your feature module.
 * ```ts
 * @NgModule({
 *   imports: [
 *     // ...
 ...
 *
 * ```html
 * <dy-toggle [(checked)]="checked"></dy-toggle>
 * ```
 *
...
@Component({
    ...
    <label class="toggle-label">
      ...
      <div class="toggle" [class.checked]="checked">
        <span [@position]="checkState()" class="toggle-switcher">
          <dy-icon *ngIf="checked" icon="checkmark-bold-outline" pack="nebular-essentials"></dy-icon>
        </span>
      </div>
      <span class="text">
  ...
  providers: [{
    ...
    useExisting: forwardRef(() => DyToggleComponent),
    multi: true,
  }],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DyToggleComponent implements OnInit, AfterViewInit, OnDestroy, ControlValueAccessor {
  ...
  constructor(
    ...
    private layoutDirection: DyLayoutDirectionService,
