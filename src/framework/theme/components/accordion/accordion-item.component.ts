...
/**
 * Component intended to be used within `<dy-accordion>` component
 */
@Component({
  selector: 'dy-accordion-item',
  styleUrls: ['./accordion-item.component.scss'],
  template: `
    <ng-content select="dy-accordion-item-header"></ng-content>
    <ng-content select="dy-accordion-item-body"></ng-content>
  `,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DyAccordionItemComponent implements OnInit, OnChanges, OnDestroy {
  ...
  static ngAcceptInputType_collapsed: DyBooleanInput;
  ...
  static ngAcceptInputType_expanded: DyBooleanInput;
  ...
  constructor(@Host() private accordion: DyAccordionComponent, private cd: ChangeDetectorRef) {
  }
