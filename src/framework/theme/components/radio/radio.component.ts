...
/**
 * The `DyRadioComponent` provides the same functionality as native `<input type="radio">`
 ...
 * ### Installation
 *
 * Import `DyRadioModule` to your feature module.
 *
 * ```ts
 * @NgModule({
 *   imports: [
 ...
 * ### Usage
 *
 * Radio buttons should be wrapped in `dy-radio-group` to provide form bindings.
 *
 * ```html
...
export class DyRadioComponent {
   ...
   * In case option 'name' isn't set on dy-radio component we need to set name
