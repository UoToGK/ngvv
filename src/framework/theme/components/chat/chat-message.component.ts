...
import { DyChatMessageFile } from './chat-message-file.component';
...
export class DyChatMessageComponent {
  ...
  static ngAcceptInputType_reply: DyBooleanInput;
