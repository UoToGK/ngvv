 ...
 */
@Directive({
  selector: '[dyListPageTracker]',
})
export class DyListPageTrackerDirective implements AfterViewInit, OnDestroy {
  ...
  @ContentChildren(DyListItemComponent, { read: ElementRef })
