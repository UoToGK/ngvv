...
import { DyIconComponent } from './icon.component';
...
export class DyIconModule {
  ...
  constructor(private iconsLibrary: DyIconLibraries) {
    ...
    this.iconsLibrary.registerSvgPack(this.essentialsPackName, {
      ...
      'minus-bold-outline': '<svg xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor" viewBox="0 0 8 2" width="100%" height="100%"><defs><rect id="dy-mbo" y="3" width="8" height="2" rx="1"/></defs><use xlink:href="#dy-mbo" transform="translate(0 -3)" fill-rule="evenodd"/></svg>',
      'checkmark-bold-outline': '<svg xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor" viewBox="0 0 8 7" width="100%" height="100%"><defs><path id="dy-cbo" d="M6.039 1.43a1.11 1.11 0 0 1 1.517-.228c.483.342.588.998.234 1.466L4.431 7.1a1 1 0 0 1-1.492.115L.317 4.677a1.023 1.023 0 0 1 .002-1.483 1.113 1.113 0 0 1 1.535.002l1.641 1.59L6.04 1.428z"/></defs><use xlink:href="#dy-cbo" transform="translate(0 -1)" fill-rule="evenodd"/></svg>',
