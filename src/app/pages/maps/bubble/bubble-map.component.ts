...
@Component({
  ...
  template: `
    <dy-card>
      <dy-card-header>Bubble Maps</dy-card-header>
    ...
    combineLatest([
      ...
      .subscribe(([map, config]: [any, any]) => {
        ...
        this.mapData = [
          ...
          { 'code': 'FR', 'name': '法国', 'value': 63125894, 'color': this.getRandomGeoColor() },
          ...
          { 'code': 'DE', 'name': '德国', 'value': 82162512, 'color': this.getRandomGeoColor() },
